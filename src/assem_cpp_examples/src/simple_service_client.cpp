...
public:
    ...
    {
        client_ = create_client<assem_msgs::srv::AddTwoInts>("add_two_ints");

        auto request = std::make_shared<assem_msgs::srv::AddTwoInts::Request>();
        request->a = a;
        request->b = b;
...
private:
    rclcpp::Client<assem_msgs::srv::AddTwoInts>::SharedPtr client_;

    void responseCallback(rclcpp::Client<assem_msgs::srv::AddTwoInts>::SharedFuture future)
    {
        if(future.valid())
        {
